...
const ListarProdutos = ({ onBack }) => {
  ...
  const produtosFiltradosOrdenados = () => {
    ...
    if (mostrarApenasFavoritos) {
      resultado = resultado.filter((produto) => isFavorito(produto.codigo));
    }
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <button
                    ...
                    className="absolute bottom-4 right-4 p-2 rounded-full bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-all duration-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`h-6 w-6 ${
                        isFavorito(produto.codigo)
